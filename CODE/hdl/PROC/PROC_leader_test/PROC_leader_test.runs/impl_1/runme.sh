...
HD_PWD='D:/CMPE_Capstone/CODE/hdl/PROC/PROC_leader_test/PROC_leader_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RF_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RF_top.tcl -notrace
