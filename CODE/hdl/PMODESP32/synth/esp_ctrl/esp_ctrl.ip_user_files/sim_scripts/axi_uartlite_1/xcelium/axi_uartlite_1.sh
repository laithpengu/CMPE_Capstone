...
#                script (type 'axi_uartlite_1.sh -help' for more information).
#
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_uartlite_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_uartlite_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_uartlite_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
