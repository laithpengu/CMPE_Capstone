...
HD_PWD='C:/Users/JohnPC/Documents/GitHub/CMPE_Capstone/CODE/hdl/PMODESP32/synth/esp_ctrl/esp_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log esp_ctrl_dbg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source esp_ctrl_dbg.tcl
