...
HD_PWD='C:/Users/SethT/Desktop/CMPE_Capstone/CODE/hdl/RF_read/RF_read.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rf_read_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rf_read_top.tcl -notrace
