...
#
# Script generated by Vivado on Fri Apr 12 12:15:15 -0400 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/CMPE_Capstone/CODE/hdl/PMODESP32/synth/esp_ctrl/esp_ctrl.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
