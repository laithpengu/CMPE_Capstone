...
#
# Script generated by Vivado on Fri Dec 15 21:14:21 -0500 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/CMPE_Capstone/CODE/hdl/pkt_display/pkt_display.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
