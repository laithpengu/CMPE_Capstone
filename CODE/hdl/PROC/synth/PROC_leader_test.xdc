...
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS33 } [get_ports { empty_led }]; #IO_L17N_T2_A25_15 Sch=led[4]
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { full_led }]; #IO_L18P_T2_A24_15 Sch=led[5]
...
## Pmod Header JB
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { clk_out }]; #IO_L9P_T1_DQS_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { data_out_s }]; #IO_L9N_T1_DQS_D13_14 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { intr_out }]; #IO_L10P_T1_D14_14 Sch=jb_p[2]
