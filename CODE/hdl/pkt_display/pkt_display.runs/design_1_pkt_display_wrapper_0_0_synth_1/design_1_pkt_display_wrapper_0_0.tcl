...
synth_design -top design_1_pkt_display_wrapper_0_0 -part xc7a100tcsg324-1 -incremental_mode off -mode out_of_context
OPTRACE "synth_design" END { }
if { [get_msg_config -count -severity {CRITICAL WARNING}] > 0 } {
 send_msg_id runtcl-6 info "Synthesis results are not added to the cache due to CRITICAL_WARNING"
}

rename_ref -prefix_all design_1_pkt_display_wrapper_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef design_1_pkt_display_wrapper_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "design_1_pkt_display_wrapper_0_0_synth_1_synth_report_utilization_0" "report_utilization -file design_1_pkt_display_wrapper_0_0_utilization_synth.rpt -pb design_1_pkt_display_wrapper_0_0_utilization_synth.pb"
...
OPTRACE "design_1_pkt_display_wrapper_0_0_synth_1" END { }
