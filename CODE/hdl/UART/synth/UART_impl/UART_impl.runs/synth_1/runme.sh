...
HD_PWD='C:/Users/JohnPC/Documents/GitHub/CMPE_Capstone/CODE/hdl/UART/synth/UART_impl/UART_impl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_impl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_impl.tcl
