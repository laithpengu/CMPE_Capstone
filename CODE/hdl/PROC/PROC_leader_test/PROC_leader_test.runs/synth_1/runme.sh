...
HD_PWD='D:/CMPE_Capstone/CODE/hdl/PROC/PROC_leader_test/PROC_leader_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RF_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RF_top.tcl
