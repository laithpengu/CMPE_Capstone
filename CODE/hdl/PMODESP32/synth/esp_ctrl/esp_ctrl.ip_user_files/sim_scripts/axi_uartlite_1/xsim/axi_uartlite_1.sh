...
#
# Script generated by Vivado on Thu May 02 23:30:32 -0400 2024
...
#
# Usage        : axi_uartlite_1.sh
#                axi_uartlite_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_uartlite_1.sh [-reset_run]
#                axi_uartlite_1.sh [-reset_log]
#                axi_uartlite_1.sh [-help]
#
...
# script info
echo -e "axi_uartlite_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_uartlite_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_3 -L lib_srl_fifo_v1_0_3 -L lib_cdc_v1_0_2 -L axi_uartlite_v2_0_33 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_uartlite_1 xil_defaultlib.axi_uartlite_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_uartlite_1 -key {Behavioral:sim_1:Functional:axi_uartlite_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="J:/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_uartlite_1.wdb xsim.dir libdpi.so)
...
Usage: axi_uartlite_1.sh [-step]\n\
Usage: axi_uartlite_1.sh [-lib_map_path]\n\
Usage: axi_uartlite_1.sh [-reset_run]\n\
Usage: axi_uartlite_1.sh [-reset_log]\n\
Usage: axi_uartlite_1.sh [-keep_index]\n\
