...
HD_PWD='C:/Users/SethT/Desktop/CMPE_Capstone/CODE/hdl/RF_read/RF_read.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rf_read_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rf_read_top.tcl
