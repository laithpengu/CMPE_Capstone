...
## LEDs
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { empty_led }]; #IO_L16N_T2_A27_15 Sch=led[2]
...
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { rd_en }]; #IO_L19P_T3_A22_15 Sch=btn[1]
