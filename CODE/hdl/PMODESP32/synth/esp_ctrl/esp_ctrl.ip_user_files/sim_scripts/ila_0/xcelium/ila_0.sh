...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../esp_ctrl.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../esp_ctrl.gen/sources_1/ip/ila_0/hdl/verilog" \
