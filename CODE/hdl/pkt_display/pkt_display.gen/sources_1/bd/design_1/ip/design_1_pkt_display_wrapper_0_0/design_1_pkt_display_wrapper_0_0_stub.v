...
module design_1_pkt_display_wrapper_0_0(clk, BTNC, BTND, an, ca, cb, cc, cd, ce, cf, cg, dp)
/* synthesis syn_black_box black_box_pad_pin="BTNC,BTND,an[7:0],ca,cb,cc,cd,ce,cf,cg,dp" */
