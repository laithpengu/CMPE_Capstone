...
HD_PWD='C:/Users/JohnPC/Documents/GitHub/CMPE_Capstone/CODE/hdl/esp32_rx_ctrl/esp32_rx_ctrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log esp_rx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source esp_rx.tcl -notrace
