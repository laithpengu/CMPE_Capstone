...
HD_PWD='D:/CMPE_Capstone/CODE/hdl/PROC/PROC_leader_test/PROC_leader_test.runs/design_1_RF_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_RF_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_RF_top_0_0.tcl
