...
#
# Script generated by Vivado on Mon Mar 11 10:34:15 -0400 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/CMPE_Capstone/CODE/hdl/PROC/PROC_leader_test/PROC_leader_test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
